...
public class BucketRepositoryImpl implements BucketRepository {
    ...
    @Override
    public int addBucketProduct(int productId, int userId) {
    ...
    @Override
    public void deleteUserBucketProductsById(int userId) {
        MapSqlParameterSource mapSqlParameterSource = new MapSqlParameterSource()
            .addValue("userId", userId);
    ...
    @Override
    public int deleteUserBucketProductById(int productId, int userId) {
        MapSqlParameterSource mapSqlParameterSource = new MapSqlParameterSource()
            .addValue("productId", productId)
            .addValue("userId", userId);
    ...
    @Override
    public int deleteUserBucketOneProductById(int productId, int userId) {
        MapSqlParameterSource mapSqlParameterSource = new MapSqlParameterSource()
            .addValue("productId", productId)
            .addValue("userId", userId);
    ...
    @Override
    public List<Product> getBucketProductsByUserId(int id) {
        MapSqlParameterSource mapSqlParameterSource = new MapSqlParameterSource()
            .addValue("userId", id);
