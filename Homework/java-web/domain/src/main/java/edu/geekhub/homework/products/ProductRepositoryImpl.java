...
public class ProductRepositoryImpl implements ProductRepository {
    ...
    private static final String UPDATE_PRODUCT_BY_ID = """
        ...
        WHERE id=:id
        """;
    private static final String FETCH_PRODUCTS_ORDERS_SORTED_PAGINATION = """
        SELECT * FROM Products
    ...
    private static final String FETCH_PRODUCTS_RATING_SORTED_PAGINATION = """
        ...
        FROM Reviews WHERE Reviews.productId = Products.id)
        DESC
        LIMIT :limit
        OFFSET :limit * :pageNumber
        """;
    ...
    @Override
    public List<Product> getProductsOrdersSortedWithPagination(int limit,
                                                               int pageNumber,
        ...
        return jdbcTemplate.query(FETCH_PRODUCTS_ORDERS_SORTED_PAGINATION, mapSqlParameterSource,
            (rs, rowNum) -> new Product(
                rs.getInt("id"),
                rs.getString("name"),
                rs.getDouble("price"),
